...
from .views import (
    clientViewSet, CodesViewSet, rateViewSet, subscriptionViewSet,
    get_expiring_subscriptions, update_subscription, delete_subscription,
    apply_referral, client_list, SubscriptionDetail, update_subscription_dateend,
)
